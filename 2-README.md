# AuthwithQQ - Authorize and bind using QQ.
A template for building PaperMC/Spigot Minecraft server plugins!

[![Test and Release](https://github.com/cc_cece/AuthwithQQ/actions/workflows/main.yml/badge.svg)](https://github.com/cc_cece/AuthwithQQ/actions/workflows/main.yml)
...
commands:
  authwithqq:
    description: Base command for AuthwithQQ
    usage: "For a list of commands, type /authwithqq help"
    aliases: qqauth
permissions:
  authwithqq.admin:
    description: DESCRIPTION
